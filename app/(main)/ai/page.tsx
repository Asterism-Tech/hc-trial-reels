  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-[#666] text-sm mt-1">Auto-generated insights and conversational analysis</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6" style={{ minHeight: 'calc(100vh - 200px)' }}>
          ...
          <div className="lg:col-span-2 overflow-y-auto">
            <h2 className="text-sm font-semibold text-white mb-3">Generated Insights</h2>
